...
public class Bottom_sheet_share extends BottomSheetDialogFragment {
    public static final String TAG = "ActionBottomDialog";

    int flagApi = 0;
    BottomShareOptionBinding binding;
    ...
    public static Bottom_sheet_share newInstance(Activity activity, Bundle bundle) {
        Bottom_sheet_share filter_bottom_sheet = new Bottom_sheet_share();
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        binding = DataBindingUtil.inflate(
                LayoutInflater.from(getContext()), R.layout.bottom_share_option, null, false);
